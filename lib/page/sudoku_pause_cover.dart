...
class SudokuPauseCoverPage extends StatelessWidget {
  const SudokuPauseCoverPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final _state = ScopedModel.of<SudokuState>(context);
...
/// old code with stateful widget will remove soon
///
